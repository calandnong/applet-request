## 增加根据commit生成changelog机制
参考文章：
https://zhuanlan.zhihu.com/p/392303778/
https://blog.csdn.net/qq_41887214/article/details/124353392

1、安装依赖：
```bash
pnpm install conventional-changelog conventional-changelog-cli conventional-changelog-custom-config compare-func -D -w
```
2、自定义 changelog
